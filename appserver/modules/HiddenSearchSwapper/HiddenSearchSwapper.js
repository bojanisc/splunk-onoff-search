...
Splunk.Module.HiddenSearchSwapper = $.klass(Splunk.Module, {
    ...
    _parseRange: function(timeRange) {
        ...
        return parseInt(Splunk.util.getEpochTimeFromISO(Iso['latest']))-parseInt(Splunk.util.getEpochTimeFromISO(Iso['earliest']));
    },
